...
| Ester: R-**O-C**(R)**=O**             | *Esters* like vinyl acetate                      | Derived from an acid where at least one hydroxl group (-OH) is replaced by an -O-alkyl (alkoxy) group. Glycerides are fatty acid esters of glycerol. Usually derived from combining a carboxylic acid and an alcohol.   |
