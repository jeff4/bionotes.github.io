...
* **GER** = Reduction causes Gain of Electrons *aka* loss of oxygen from the molecule *aka* **reduces the postive charge**. eg, see what happens to Hydrogen in magnesium reaction on p. 646. The "positive +1 charge" charge of aqueous HCl *reduces* its positivity to 0 in the resulting H<sub>2</sub> gas.
...
## Recommended organic chemistry textbooks
