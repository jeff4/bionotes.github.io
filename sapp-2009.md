...
* Woese drew inspiration from [Alfred North Whitehead's](https://en.wikipedia.org/wiki/Alfred_North_Whitehead) [process philosophy](https://en.wikipedia.org/wiki/Process_philosophy#Whitehead's_Process_and_Reality). 
	* Cartesian dualism (aka classical [substance dualism](https://en.wikipedia.org/wiki/Mind–body_dualism#Substance_or_Cartesian_dualism)) has an ontology whereby reality ultimately consists of [either into physical Matter or mental/immaterial Mind](https://en.wikipedia.org/wiki/Mind–body_dualism). Furthermore, Matter consists of very small, independent bits of material. 
	* In contrast to Cartesian matter, Whitehead proposed an [ontology based on interrelated processes and events](https://en.wikipedia.org/wiki/Process_philosophy).
