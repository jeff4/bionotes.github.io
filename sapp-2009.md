...
* See also [*The Tangled Tree: A Radical History of Life*](https://www.amazon.com/Tangled-Tree-Radical-History-Life/dp/1476776628) (2018) by David Quammen

## Chapters 1: Animal, Vegetable, or Mineral? p. 3-16
* [Robert Hooke](https://en.wikipedia.org/wiki/Robert_Hooke) (1635–1703) updated the compound microscope by adding a third lens and drew beautiful illustrations in [*Micrographia* (1665)](https://en.wikipedia.org/wiki/Micrographia). p. 4
* [Antony van Leeuwenhoek](https://en.wikipedia.org/wiki/Antonie_van_Leeuwenhoek) (1632–1723) made simpler and better microscopes than Hooke's models.  
...
* [Carl Woese](https://en.wikipedia.org/wiki/Carl_Woese) (1928–2012) finished his doctoral research in biophysics in 1953 at Yale, outside of the mainstream of microbiology.
	...
	* Woese subsequently returned as a postdoc to the lab of his PhD advisor [Ernest Pollard](https://en.wikipedia.org/wiki/Ernest_C._Pollard) at Yale. Pollard was the founder of the biophysics group at Yale and created the Department of Biophysics at [Penn State](https://en.wikipedia.org/wiki/Pennsylvania_State_University).  
* Cosmologist George Gamow (1904–1968) proposed that the genetic code consisted of triplet codons that fit into the diamond-sshpaed cavities of dsDNA. He also believed that the code was overlapping. e.g, the codon A**CG** could only be followed by **CG**A,  **CG**T, **CG**C, or **CG**G. "However, as the peptide sequence data accumulated, it became increasingly clear that no such 'neighbor restrictions' existed." p. 147
...
* In 1961, Marshall Nirenberg and Heinrich Matthaei at the NIH in Bethesda, MD showed that a triple-uracil codon (UUU) coded for phenylalaninine. And a poly-U RNA of many uracils leads to a long polypeptide of polyphenylalaninine. The called it the U-3 incident after the [U-2 spy plane incident of 1960](https://en.wikipedia.org/wiki/1960_U-2_incident).
...
* That same year, [Sol Spiegelman](https://en.wikipedia.org/wiki/Sol_Spiegelman) from the University of Illinois visited Paris looking for new faculty to add to the campus at Urbana-Champaign. 
* Spiegelman and Benjamin Hall had "developed a DNA-RNA hybridization technique using *E. coli* and bacteriophage T<sub>2</sub> that...acted much like [the messenger RNA system] conceived by [Jacques Monod](https://en.wikipedia.org/wiki/Jacques_Monod), [François Jacob](https://en.wikipedia.org/wiki/François_Jacob), and [Matt Meselson](https://en.wikipedia.org/wiki/Matthew_Meselson)."
...
* Woese drew inspiration from [Alfred North Whitehead's](https://en.wikipedia.org/wiki/Alfred_North_Whitehead) [process philosophy](https://en.wikipedia.org/wiki/Process_philosophy#Whitehead's_Process_and_Reality). 
	* Cartesian dualism (aka classical [substance dualism](https://en.wikipedia.org/wiki/Mind–body_dualism#Substance_or_Cartesian_dualism)) has an ontology whereby reality ultimately consists of [*either*](https://en.wikipedia.org/wiki/Mind–body_dualism) physical Matter *or* mental/immaterial Mind. Furthermore, Matter consists of very small, independent bits of material. 
	* In contrast, Whitehead proposed an [ontology based on interrelated processes](https://en.wikipedia.org/wiki/Process_philosophy); where events, patterns, and change are considered fundamental rather than objects and matter, or as Whitehead termed it "irreducible brute matter." [Whitehead: "All Things Flow"](https://en.wikipedia.org/wiki/Alfred_North_Whitehead#Whitehead's_conception_of_reality).
	...
	* In summary, [Whitehead conceived](https://en.wikipedia.org/wiki/Alfred_North_Whitehead#Whitehead's_conception_of_reality) of "reality as composed of processes of dynamic 'becoming' rather than static 'being', emphasizing that all physical things change and evolve, and that changeless 'essences' such as matter are mere abstractions from the interrelated events that are the final real things tha make up the world."
...
* This conneted with speculation about how RNA could play an enzyme-like role, esp. early in the history of life. Woese (and Crick and [Orgel](https://en.wikipedia.org/wiki/Leslie_Orgel)) played with the idea of [ribozymes](https://en.wikipedia.org/wiki/Ribozyme#Discovery) before the term was coined by Kelly Kruger et al in 1982.
...
* Watson's *Molecular Biology of the Gene* first appeared in 1965 and [*MBOC*](https://en.wikipedia.org/wiki/Molecular_Biology_of_the_Cell_(book)) first appeared in 1983. Both of these books mapped the perimeters of molecular bio and barely mentioned evolution. p. 155
...
* By the time Woese finished [*The Genetic Code*](https://books.google.com/books/about/The_Genetic_Code.html?id=XJVqAAAAMAAJ) in 1976, he concluded "that one could not study these problems of deep evolution without a phylgenetic framework."
...
* In 1968, one of Sanger's graduate students David Bishop moved to UIUC as a postdoc to help set up Sanger's system for sequencing viral RNA in [Speigelman's lab](https://en.wikipedia.org/wiki/Sol_Spiegelman). Bishop and [Mitch Sogin](https://en.wikipedia.org/wiki/Mitchell_Sogin) built a setup for the Spiegelman lab and Woese inherited this lab at UIUC after Spiegelman moved to NY to take a position at Columbia University in 1969. (For more details, see [*The Tangled Tree: A Radical New History of Life*](https://books.google.com/books?id=bH6hDwAAQBAJ&pg=PA57&lpg=PA57&dq=%22david+bishop%22++sanger+DNA&source=bl&ots=Hbvl4La4su&sig=ACfU3U0O-y0VCOvTuqWdyKPgeJqz_vSR6g&hl=en&sa=X&ved=2ahUKEwjAkLPx7KntAhXpSzABHc1SA0AQ6AEwEXoECAcQAg#v=onepage&q=%22david%20bishop%22%20%20sanger%20DNA&f=false) p. 57-58)
* "The sequencing technology was slow and arduous, but Woese's team had the field virtually to themselves for a decade. Using the Sanger technique for RNA oligo sequencing [not to be confused with Sanger chain-termination DNA sequencing which would not be published until [1977](https://www.pnas.org/content/74/12/5463)], many small pieces of RNA could be separated by electrophoresis and then catalog."
* "The long RNA molecule was broken into small fragments several nucleotides long by cutting at every G residue with [Ribonuclease T<sub>1</sub>](https://en.wikipedia.org/wiki/Ribonuclease_T1) a restriction endonuclease that cuts RNA at every guanine...Then, these smaller fragments would be cut by other enzymes that cut at other specific nucleotides. This method allowed them to reconstruct the nucleotide sequence of each original rRNA fragment."
* [Sogin](https://en.wikipedia.org/wiki/Mitchell_Sogin) was critical to developing and implementing the lab equipment and setup, "increasing the capacity of the lab from two to six Sanger tanks. Thanks to Sogin's efforts, the Woese lab was able to catalog the RNA sequence for various taxa." 
...
* Ribosomes have two subunits: (a) the small subunit has a 16S rRNA; and (b) [a large subunit (LSU)](https://en.wikipedia.org/wiki/LSU_rRNA) which has a 23S RNA component and a 5s RNA component.  [See this Wiki table](https://en.wikipedia.org/wiki/Ribosome#Bacterial_ribosomes) for more details.
* After some trial and error, the team began focusing on the 16S rRNA aka the SSU rRNA.
* The comparative cataloging approach "provided information from only about 35% of the 16S rRNA. Sequencing the entire 16S rRNA gene was not feasible unitl the late 1970s." For more, see [this 1978 paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC336208/) and then this [Woese lab paper on a complete archeaon 16S rRNA in 1983](https://pubmed.ncbi.nlm.nih.gov/17787735/). p. 160
...
* "The collaboration between Woese and [George Fox](https://en.wikipedia.org/wiki/George_E._Fox) was especially vibrant for many years."
...
* [Alexander Oparin's](https://en.wikipedia.org/wiki/Alexander_Oparin) famous [primordial soup conjecture](https://en.wikipedia.org/wiki/Primordial_soup) was that the first forms of life on our planet were anaerobic heterotrophs that fed on the organic molecules in the "rich hot soup" of the early Earth.


## Chapter 17: Big Tree p. 226-242
* In 1979, Robert Schwartz and Margaret Dayhoff published [*Origin of Prokaryotes, Eukaryotes, Mitochondria, and Chloroplasts*](https://pubmed.ncbi.nlm.nih.gov/202030/) in **Science**. The paper offered 4 alternative trees based on: (1) [ferredoxin](https://en.wikipedia.org/wiki/Ferredoxin) in green plants and some anaerobic bacteria; (2) 5S rRNA; (3) [c-type cytochromes](https://en.wikipedia.org/wiki/Cytochrome_c); and (4) a composite of the 3 previous molecular genealogies (p. 228)
	* Discussion of Schwartz and Dayhoff (p. 228-231)

### Proving Symbiosis Theory
* Transfer of knowledg/techniques about 16S rRNA sequencing from UIUC (Sol Spiegelman and Carl Woese labs) to [Dalhousie University](https://en.wikipedia.org/wiki/Dalhousie_University) labs of [Michael Gray](https://medicine.dal.ca/departments/department-sites/biochemistry-molecular-biology/our-people/faculty/gray.html) and [W. Ford Doolittle](https://en.wikipedia.org/wiki/Ford_Doolittle) via Spiegelman/Wose lab alum Linda Bonen. (p. 232-234)

### Can Only God Make a Tree?
* The "Big Tree" paper by Woese, Fox, L. Bonen, Stackebrandt, Kandler, et al published in **Science** in 1980: [*The Phylogeny of Prokaryotes*](https://pubmed.ncbi.nlm.nih.gov/6771870/)
