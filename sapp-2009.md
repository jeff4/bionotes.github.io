...
* Edwin Copeland's three conventions of constructing taxonomic systems:
	1. Common descent and a prepondarance of common characters indicating that descent to form "natural groups". p. 77
	...
	1. The type method: a group is named with a specific "paragon" example representing the group.
